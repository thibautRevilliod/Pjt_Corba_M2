...
import LanceurEntiteLogicielle.LanceurEntiteLogicielleAnnuaire;
import LanceurEntiteLogicielle.LanceurEntiteLogicielleAutorisation;
import LanceurEntiteLogicielle.LanceurEntiteLogicielleEmpreinte;
import LanceurEntiteLogicielle.LanceurEntiteLogicielleJournalisation;
import LanceurEntiteLogicielle.LanceurEntiteLogiciellePorte;

public class Runnable_all_Serveur implements Runnable {
	//TODO : pour simplifier les tests; les methodes sont de type public
	private String[] args;
	private String nomServeur;
	
	public Runnable_all_Serveur(String[] _args, String _nomServeur){
		this.args = _args;
