		...
		if(!vm.getComboBox().getSelectedItem().equals(""))
		{
			try {
				...
				for(int i = 0 ; i < infoSalarieAccreditation.listeAccreditationSal.length; i++)
				{
					...
					rowData[i][3] = infoSalarieAccreditation.listeAccreditationSal[i].heureDebut.timestamp.substring(11, 19);
					rowData[i][4] = infoSalarieAccreditation.listeAccreditationSal[i].heureFin.timestamp.substring(11, 19);
					...
					System.out.println(infoSalarieAccreditation.listeAccreditationSal[i].heureDebut.timestamp);
					System.out.println(infoSalarieAccreditation.listeAccreditationSal[i].heureDebut.timestamp);
				}
