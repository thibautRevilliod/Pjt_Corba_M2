...
/** 
 * Helper class for : ListeSalaries
 *  
 * @author OpenORB Compiler
 */ 
public class ListeSalariesHelper
{
    ...
    /**
     * Insert ListeSalaries into an any
     * @param a an any
    ...
    /**
     * Extract ListeSalaries from an any
     * @param a an any
    ...
    public static modControledAcces.InfoSalarie[] extract(org.omg.CORBA.Any a)
    {
        ...
        if(HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof modControledAcces.ListeSalariesHolder)
                    return ((modControledAcces.ListeSalariesHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            modControledAcces.ListeSalariesHolder h = new modControledAcces.ListeSalariesHolder(read(a.create_input_stream()));
    ...
    /**
     * Return the ListeSalaries IDL ID
     * @return an ID
     */
    ...
    private final static String _id = "IDL:modControledAcces/ListeSalaries:1.0";
